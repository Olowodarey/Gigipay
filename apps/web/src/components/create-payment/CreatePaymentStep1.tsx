      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            A unique identifier for your giveaway (max 31 characters). Each
            giveaway must have a different name.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) =>
              onChange("selectedToken", (e.target as HTMLSelectElement).value)
            }
          >
        ...
        <div className="space-y-2">
          <label htmlFor="totalPrize" className="text-sm font-medium">
          ...
          <input
            ...
            onChange={(e) =>
              onChange("totalPrize", (e.target as HTMLInputElement).value)
            }
            min="0"
            step="0.01"
          />
        ...
        <div className="space-y-3">
          <label htmlFor="expiryHours" className="text-sm font-medium">
            Expiry Time
          </label>
